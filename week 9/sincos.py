...
drawSin = font.render(' ', True, BLACK, WHITE)
SinRect = drawSin.get_rect()
SinRect.left = 735
SinRect.bottom = 30
drawCos = font.render(' ', True, BLACK, WHITE)
...
while True:
    ...
    pygame.draw.line(screen, BLACK, (70, 280), (730, 280), 3)  # X
    pygame.draw.line(screen, BLACK, (400, 10), (400, 550), 3)  # Y
